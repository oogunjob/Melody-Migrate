...
function Footer() {
    return (
        <div className="w-full h-[120px] bg-white border-gray-200 border p-5 text-center text-slate-800 flex flex-col items-center justify-center">
            ...
            <p className="mt-6 text-lg text-gray-600">Created by <a target="_blank" href="https://www.linkedin.com/in/oluwatosin-ogunjobi/" className="text-blue-500 underline">Tosin Ogunjobi</a>
            </p>
        </div>
    )
}
